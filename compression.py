...
def round_pixel(pixel, mode, image, new_palette):
    ...
    match mode:
        ...
        case "P":
            ...
            red = rounding_multiple * round(palette[pixel * 3] / rounding_multiple)
            green = rounding_multiple * round(palette[pixel * 3 + 1] / rounding_multiple)
            blue = rounding_multiple * round(palette[pixel * 3 + 2] / rounding_multiple)
            rgb = (red, green, blue)
            ...
            rounded_pixel = palette_tuples.index(rgb) #return index of our new pixel
